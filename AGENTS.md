...
- **Email bypass** — Set `NEXT_PUBLIC_DEBUG_BYPASS_EMAIL=true` to suppress all email notifications (payments, webhook, check-in). Leave unset to send emails normally.
