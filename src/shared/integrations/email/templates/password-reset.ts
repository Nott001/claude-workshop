...
function passwordResetHtml(params: PasswordResetParams): string {
  return layout(
    ...
    `      <h1 style="margin:0 0 16px;font-size:22px">Reset your password</h1>
      ...
      <p style="margin:0 0 12px">We received a request to reset the password on your ${BRAND} account. Use the button below to choose a new one.</p>
